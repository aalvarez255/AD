...
public class registro extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        String user = request.getParameter("usuario_reg");
        ...
        try {          
            ...
            ResultSet rs = statement.executeQuery("select * from usuarios where id_usuario = '"+user+"'");
            ...
            if (!found) {
                statement.executeUpdate("insert into usuarios (id_usuario,password) values('"+user+"','"+password+"')");
                ...
                request.setAttribute("register","0");
